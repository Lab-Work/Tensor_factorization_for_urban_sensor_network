function [X_hat, E_hat, O_hat,iter] = inexact_alm_rmc21(D,Sigma_bar, lambda, tol, maxIter, outlier_dim)
%% Sept 2019
...
%
% outlier_dim - the dimension along which outlier fiber lies. By default the outlier fiber is assumed to be
...
%     fprintf('mu is %.2f\n',mu)
    ...
    temp_Tm = tenmat(temp_T,outlier_dim);
